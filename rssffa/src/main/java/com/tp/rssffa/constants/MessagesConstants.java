package com.tp.rssffa.constants;

public class MessagesConstants {

	public static final String ERROR = "Internal server error, please contact administrator.";
	public static final String URL_LIST_IS_EMTPY = "URL list is empty.";
	public static final String URL_LIST_MINIMUM = "There must be at least 2 url links.";
